...
app.post("https://newsclick-backend.onrender.com",(req,res)=>{
...
app.get('https://newsclick-backend.onrender.com/news',async(req,res)=>{
...
app.post('https://newsclick-backend.onrender.com/news',(req,res)=>{
